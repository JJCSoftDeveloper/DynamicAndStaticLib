...
@class FWTPieChartView,FWTPieChartSegmentData;

@protocol FWTPieChartViewDelegate <NSObject>

- (void)FWTPieChartView:(FWTPieChartView *)v didTouchAtSegment:(FWTPieChartSegmentData *)date atIndex:(NSInteger)index;
...
@property (nonatomic, weak) id<FWTPieChartViewDelegate> delegete;
